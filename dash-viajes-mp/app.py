    ...
    children=[
                                    ...
                                    [
                                        html.Div(
                                            ...
                                            html.A(
                                                ...
                                                html.Div(
                                                    [
                                                        html.H4("Gastos Viajes"),
                                                        html.H6("Compra de pasajes nacionales e internacionales con precios sobre el doble del precio promedio del mercado"),
                                                    ],
                                                    className="page-1b",
                                                ),
                                            ],
        ...
        html.Div(
            [
                html.Div(
                    [
                        html.Div([html.H1("Gastos Viajes")], className="page-2a"),
                        html.Div(
                            [
        ...
        html.Div(
            [
                html.Div(
                    [
                        html.Div([html.H1("Gastos Viajes")], className="page-3a"),
                        html.Div(
                            [
                                html.Div(
                                    [
                                ...
                                html.Div(
                                    [
                                        html.Div(
                                            [
                                                html.Strong(
                                                    "Diferencia en gastos de pasajes en Chile",
                                                    className="page-3h",
                                                ),
                                                html.P(
                                        ...
                                        html.Div(
                                            [
                                                html.Strong(
                                                    "Comparación gastos en pasajes al 2020",
                                                    className="page-3h",
                                                ),
                                                html.P(
                        ...
                        html.Div(
                            [
                                html.Div(
                                    [
                                        html.Strong(
                                            "Aumento de gastos en pasajes en el sector público de 2010 al 2020",
                                            style={
                                                "color": color_1,
                                                "padding-top": "100px",
                                            },
                                ...
                                html.Div(
                                    [
                                        html.Div(
                                            [
                                                html.Strong(
                                                    "Aumento consumo gasto público pasajes y viáticos",
                                                    className="page-3h",
                                                ),
                                                html.P(
                                                    "Quis mauris dolor amet cubilia mattis, finibus magnis lacus",
                                        ...
                                        html.Div(
                                            [
                                                html.Strong(
                                                    "Diefrencias gastos en viajes de empresas",
                                                    className="page-3h",
                                                ),
                                                html.P(
                                                    "Praesent, morbi, rhoncus habitant at maximus mauris",
